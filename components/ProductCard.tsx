        ...
        <Link href={`/${product.slug}`} className="block">
          ...
          <div className="product-content p-2 sm:p-3 space-y-1 sm:space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <Button
                size="sm"
                className="product-button bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-700 hover:to-orange-600 text-white shadow-lg hover:shadow-xl transition-all duration-200 h-6 w-6 sm:h-8 sm:w-8 p-0 rounded-full flex-shrink-0 z-10"
